...
const galeryItemsMarkup = createGalleryItemsMarkup(galleryItems)
...
galleryRef.insertAdjacentHTML('beforeend', galeryItemsMarkup)
...
modalOverlayRef.addEventListener('click', onBackdrop)